...
alias lsgitremote='paste  <(for i in *; do if [ -d "$i"/.git ] ; then echo -e "git clone -b \033[1;31m$(git --git-dir="$i"/.git symbolic-ref --short HEAD)\033[0m $(git  --git-dir="$i"/.git remote get-url origin) $i"; else echo; fi; done)'
